...
public class RoomTypeListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<RoomType> lst = roomTypeDao.findAll();
		request.setAttribute("roomtypelist", lst);
		request.getRequestDispatcher("admin/html/roomtype_list.jsp").forward(request, response);
		System.out.println("++++++++");
