...
public class CustomerUpdateServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int id = Integer.parseInt(request.getParameter("customerpk"));
		...
		Customer customer = new Customer(id, customertypeid, customerid, customername, customersex, customerhao, customertel, customerremark);
