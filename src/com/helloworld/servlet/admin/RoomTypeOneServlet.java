...
public class RoomTypeOneServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RoomType roomType = roomTypeDao.findByPk(id);
		request.setAttribute("roomtype", roomType);
		request.getRequestDispatcher("admin/html/roomtype_update.jsp").forward(request, response);
		out.flush();
		out.close();
	}
