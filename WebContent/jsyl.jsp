      ...
      <td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="632" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="253" align="right" valign="middle"><font style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:6E4B25;">LK International Hotel</font></td>
          </tr>
          <tr>
        ...
        <table width="632" height="97" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="middle" style="line-height:20px"><a href="#" > <img src="img/65.jpg" alt="水疗馆" width="167" height="51" border="0" /></a></td>
            <td align="center" valign="middle" style="line-height:20px"><a href="#" ><img src="img/66.jpg" alt="健身中心" width="167" height="51" border="0" /></a></td>
            <td align="center" valign="middle" style="line-height:20px"><a href="#" ><img src="img/67.jpg" alt="中原首家泰国风情KTV" width="167" height="51" border="0" /></a></td>
          </tr>
        </table>
        <table width="632" height="66" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<P><STRONG>水疗馆</STRONG></P>
<P>13000平方米的水疗中心，1500平方米的天然地矿温泉游泳馆，和多达76间的各式豪华包房；并设有芬兰浴、冲浪浴、盐浴、香薰花浴、悬浮浴、足浴、泰式按摩等服务项目，更有贵宾休息大厅和专用自助餐厅。</P><FONT face=Verdana>正在筹备中......</FONT>			</td>
          </tr>
        </table>
