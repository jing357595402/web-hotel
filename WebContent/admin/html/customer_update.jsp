					...
					<td>
						...
						<div id="content-table-inner">
							<table border="0" width="100%" cellpadding="0" cellspacing="0">
								...
								<tr valign="top">
									<td>
										<!-- start id-form -->customer
										<form action="${pageContext.request.contextPath }/CustomerUpdateServlet" method="post">
											<input value="${customer.pk}" name="customerpk" type="hidden" />
											<table border="0" cellpadding="0" cellspacing="0" id="id-form">
												<tr>
													<th valign="top">客户类型编号：</th>
													<td><input type="text" name="customertypeid" value="${customer.c_type_id}" class="inp-form-error large_input" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">客户编号：</th>
													<td><input name="customerid" value="${customer.m_id}" type="text" class="inp-form" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">客户姓名：</th>
													<td><input name="customername" value="${customer.m_name}" type="text" class="inp-form" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">客户性别：</th>
													<td><input name="customersex" value="${customer.sex}" type="text" class="inp-form" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">证件号：</th>
													<td><input name="customerhao" value="${customer.zj_no}" type="text" class="inp-form" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">联系方式：</th>
													<td><input name="customertel" value="${customer.m_tel}" type="text" class="inp-form" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
												<tr>
													<th valign="top">客户习惯：</th>
													<td><textarea rows="" name="customerremark" cols="" class="form-textarea">${customer.remark}</textarea></td>
													<td></td>
												</tr>
												<tr>
													<th>&nbsp;</th>
