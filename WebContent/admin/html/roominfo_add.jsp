        ...
        <div id="content-table-inner">
          <table border="0" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
              <td>
              <!-- start id-form -->
              <form action="${pageContext.request.contextPath }/RoomInfoAddServlet" method="post">
              <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                <tr>
                  <th valign="top">房号：</th>
                  <td><input type="text" name= "roomnum" class="inp-form-error large_input"/></td>
                  <td><div class="error-left"></div>
                    <div class="error-inner">必填项* </div></td>
                </tr>
                <tr>
                  <th valign="top">房间类型号：</th>
                  <td><input  name= "roomtypeid" type="text" class="inp-form"/></td>
                  <td><div class="error-left"></div>
                    <div class="error-inner">必填项*</div></td>
                </tr>
                <tr>
                  <th valign="top">房间状态：</th>
                  <td><input  name= "roomstate" type="text" class="inp-form"/></td>
                  <td><div class="error-left"></div>
                    <div class="error-inner">必填项*</div></td>
                </tr>
                <tr>
                  <th valign="top">房间电话：</th>
                  <td><input  name= "roomtel" type="text" class="inp-form"/></td>
                  <td><div class="error-left"></div>
                    <div class="error-inner">必填项*</div></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><textarea rows="" name= "roomremark" cols="" class="form-textarea"></textarea></td>
                  <td></td>
                </tr>
                <tr>
                  <th>&nbsp;</th>
