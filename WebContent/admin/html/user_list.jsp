		...
		<div id="content-table-inner">
			...
			<div id="table-content">
                ...
                <tr >
					...
					<td><%=pwd.getUserid() %></td>
					<td><%=pwd.getPwd() %></td>
					<td class="options-width"><a href="<%=request.getContextPath() %>/admin/html/user_add.jsp" title="Add" class="icon-3 info-tooltip"></a>
					  <a href="<%=request.getContextPath() %>/UserOneServlet?id=<%=pwd.getPk() %>" title="Update" class="icon-1 info-tooltip"></a>
				    <a href="<%=request.getContextPath() %>/UserDeleteServlet?id=<%=pwd.getPk() %>" onclick = "javascript:return confirm('确定删除该用户？')" title="Delete" class="icon-2 info-tooltip"></a></td>
				</tr>
				<% } %>
				</table>
				<!--  end product-table................................... --> 
			...
			<!--  start actions-box ............................................... -->
			<div id="actions-box">
           	<a href="#" class=""><img src="../images/dropdown_actions.gif"></a>&nbsp;<a href="#"  class=""><img src="../images/dropdown2.gif" /></a></div>
			<!-- end actions-box........... -->
