	...
	<div id="sidebar">
		<div id="sidebar-wrapper">
			<div id="profile-links" class="mypng">
				<img src="${pageContext.request.contextPath }/admin/images/logo.png" /> 您好, <a href="#" title="Edit your profile">${pwd.userid}</a>, <a
					href="#" target="mainFrame">我的桌面</a><br /> <br /> <a href="${pageContext.request.contextPath }/index.jsp" title="官网首页" target="blank">查看网站</a>
				| <a href="${pageContext.request.contextPath }/admin/login.jsp" title="Sign Out" target="_top">退出登陆</a>
			</div>
			...
			<div id="messages" style="display: none">
				...
				<h3>3 Messages</h3>
				<p>
					<strong>17th May 2009</strong> by Admin<br /> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis
					aliquet congue. <small><a href="#" class="remove-link" title="Remove message">Remove</a></small>
				</p>
				<p>
					<strong>2nd May 2009</strong> by Jane Doe<br /> Ut a est eget ligula molestie gravida. Curabitur massa. Donec eleifend, libero at sagittis
					mollis, tellus est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus pretium ornare est. <small><a href="#"
						class="remove-link" title="Remove message">Remove</a></small>
				</p>

				<p>
					<strong>25th April 2009</strong> by Admin<br /> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at
					felis aliquet congue. <small><a href="#" class="remove-link" title="Remove message">Remove</a></small>
				</p>
