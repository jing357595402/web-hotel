						...
						<div id="content-table-inner">
							...
							<div id="table-content">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td height="35"><a href="news_add.html" class="a_add">房间类别</a></td>
									...
									<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
										...
										<c:forEach items="${roomtypelist}" var="roomtype">
											<tr>
												...
												<td>${roomtype.foregift}</td>
												<td>${roomtype.cl_room}</td>
												<td>${roomtype.cl_price}</td>
												<td>${roomtype.remark}</td>
												<td class="options-width"><a href="${pageContext.request.contextPath }/admin/html/roomtype_add.jsp" title="Add"
													class="icon-3 info-tooltip"></a> <a href="${pageContext.request.contextPath }/RoomTypeOneServlet?id=${roomtype.pk() %>"
													title="Update" class="icon-1 info-tooltip"></a> <a
													href="${pageContext.request.contextPath }/RoomTypeDeleteServlet?id=${roomtype.pk}" onclick="javascript:return confirm('确定删除该条信息')"
