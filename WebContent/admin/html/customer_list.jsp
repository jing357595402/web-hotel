							...
							<div id="table-content">
								...
								<form id="mainform" action="">
									<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
										...
										<c:forEach items="${requestScope.cuslst}" var="cus">
											<tr>
												...
												<td>${cus.m_tel}</td>
												<td>${cus.remark}</td>
												<td class="options-width"><a href="${pageContext.request.contextPath }/admin/html/customer_add.jsp" title="Add"
													class="icon-3 info-tooltip"></a> <a href="${pageContext.request.contextPath }/CustomerOneServlet?id=${cus.pk}" title="Update"
													class="icon-1 info-tooltip"></a> <a href="${pageContext.request.contextPath }/CustomerDeleteServlet?id=${cus.pk}"
