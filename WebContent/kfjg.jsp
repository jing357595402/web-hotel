		...
		<table width="1003" height="580" border="0" cellpadding="0" cellspacing="0" background="img/47.jpg" bgcolor="#FFF4C7">
			<tr>
				<td width="234" height="580" align="left" valign="top"
					style="background: url(img/49.jpg); background-position: bottom; background-repeat: repeat;"><img src="img/42.jpg" width="234"
					height="616" /></td>
				<td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="632" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="402" height="25" align="left" valign="middle">&nbsp;<font style="font-weight: bold; font-size: 15px; color: 6E4B25;">客房展示</font>-客房价格表
							</td>
							<td width="230" align="right" valign="middle"><font
							...
							<td align="left" valign="top" style="line-height: 20px">
								<TABLE cellSpacing=1 cellPadding=5 align=center bgColor=#dcaa55 border=0>
									<TBODY>
										...
										<TR>
											<TD noWrap width=171 bgColor=#fef5cc>
												<P align=center>豪华商务套房</P>
											</TD>
											<TD width=193 bgColor=#fef5cc>
												<P align=center>2399</P>
											</TD>
											<TD vAlign=top width=204 bgColor=#fef5cc>
												<P align=center>86</P>
											</TD>
										...
										<TR>
											<TD noWrap width=171 bgColor=#fef5cc>
												<P align=center>总统套房</P>
											</TD>
											<TD width=193 bgColor=#fef5cc>
												<P align=center>39999</P>
											</TD>
											<TD vAlign=top width=204 bgColor=#fef5cc>
										...
										<TR>
											<TD noWrap width=171 bgColor=#fef5cc>
												<P align=center>豪华女士套房</P>
											</TD>
											<TD width=193 bgColor=#fef5cc>
												<P align=center>2999</P>
											</TD>
											<TD vAlign=top width=204 bgColor=#fef5cc>
