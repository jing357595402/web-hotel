...
<body leftmargin="0" topmargin="0">
	<div align="center">
		...
		<table width="1003" height="580" border="0" cellpadding="0" cellspacing="0"
			background="${pageContext.request.contextPath }/portal/imgs/22047.jpg" bgcolor="#FFF4C7">
			<tr>
				<td width="234" height="580" align="left" valign="top" background="${pageContext.request.contextPath }/portal/imgs/02.jpg"><img
					src="${pageContext.request.contextPath }/portal/imgs/11.jpg" width="234" height="651" /></td>
				<td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td><img src="${pageContext.request.contextPath }/portal/imgs/04.jpg" width="682" height="179" /></td>
						</tr>
					</table>
					...
					<table width="632" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="243" align="right" valign="middle"><font
						...
						<tr>
							...
							<td align="center" valign="top" background="${pageContext.request.contextPath }/portal/imgs/22074.jpg">
								...
								<table width="443" height="144" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td align="left" valign="top" style="line-height: 25px">地址：南京大学软件学院软件谷 邮政编码：220000<BR>联系QQ：<SPAN class=style11>123456789</SPAN>&nbsp;&nbsp;<BR>电话总机：025-52887700
											传真：025-52887700
										</td>
									</tr>
								</table> <br>
