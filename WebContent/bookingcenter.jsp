...
<style type="text/css">
<!--
.wo03 {	FONT-SIZE: 11px; COLOR: #885937; LINE-HEIGHT: 1.4; FONT-FAMILY: 新細明體
}
.wo04 {	FONT-SIZE: 11px; COLOR: #6c4900; LINE-HEIGHT: 1.4; FONT-FAMILY: Verdana
}
-->
</style>
</head>
...

{
	switch(x)
		...
		case 6:
			...
			case 8:
				if(trim(form1.femail.value)=="" || !(isEmail(form1.femail.value)))
...
<div align="center">
  ...
  <table width="1003" height="580" border="0" cellpadding="0" cellspacing="0"  background="img/47.jpg"  bgcolor="#FFF4C7" >
    <tr>
      <td width="234" height="580" align="left" valign="top"  background="img2/02.jpg"  ><img src="img2/11.jpg" width="234" height="651" /></td>
      <td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="632" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="234" align="right" valign="middle"><font style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:6E4B25;">LK International Hotel</font></td>
          </tr>
          <tr>
		...
		<tr>
            <td align="left" valign="top"><img src="img/72.jpg" width="626" height="41"></td>
          </tr>
          <tr>
           <form id="form1" name="form1" method="post" action="ydzx1.asp"  onsubmit="return checkform() "> <td align="center" valign="top" background="img/74.jpg">
			<table cellspacing="1" cellpadding="5" width="91%" align="center" border="0">
             ...
             <select name="kflx"  id="kflx" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 160px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff"    onchange="change(this)" >
			  ...
			  <option value="9">总统套房</option>
               ...
               <tr >
                 ...
                 <td align="left" valign="middle"  >   
                   ...
                   <input  size="15" name="fs"  id="fs" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #eff4dd"  onblur="miss(1)"   />
               ...
               <tr>
                 ...
                 <td align="left" valign="middle" ><input  size="15" 
                  name="rs" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff" onBlur="miss(2)"  />
               ...
               <tr>
                 ...
                 <td align="left" valign="middle" height="28" ><input 
                   size="35" name="name1" id="name1" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #eff4dd" onBlur="miss(3)"   />
               ...
               <tr >
                 ...
                 <td align="left" valign="middle">
                  <INPUT 
                              name=xsex type=radio class="inputCheck" value=小姐 CHECKED> 
                   <SPAN class=wo01>小姐</SPAN> <INPUT name=xsex 
                              type=radio class="inputCheck" value=先生> 
                   <SPAN 
                              class=wo01>先生</SPAN></td>
               </tr>
               ...
               <tr >
                 ...
                 <td align="left" valign="middle">
					<input  size="35" name="company1"  style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff"   onblur="javascript:miss(5)" />          <div style="position: absolute;" id="layer5"></div>       </td>
               </tr>
               <tr >
                 <td align="right" valign="middle">联系电话</td>
                 <td align="left" valign="middle"><input  size="35" name="tel" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #eff4dd"  onblur="javascript:miss(6)"/>                      
                 * 02034709708 &nbsp;&nbsp;&nbsp;
                 <div style="position: absolute;" id="layer6"></div></td>
               </tr>
               <tr >
                 <td align="right" valign="middle">传　　真：</td>
                 <td align="left" valign="middle"><input  size="35" name="fax"  style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff" onBlur="javascript:miss(7)" />                    02034709708 &nbsp;&nbsp;&nbsp;      <div style="position: absolute;" id="layer7"></div>    </td>
               </tr>
               <tr >
                 <td align="right" valign="middle">电子邮箱</td>
                 <td align="left" valign="middle"><input  size="35" name="femail"  id="femail" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #eff4dd"  onblur="javascript:miss(8)"/>
                   * <div style="position: absolute;" id="layer8"></div></td>
               </tr>
               <tr >
                 <td align="right" valign="middle" height="27">您从哪里来：</td>
                 <td align="left" valign="middle" height="27"><input  id="where" size="35" 
                  name="where"  style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 114px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff" onBlur="javascript:miss(9)" />
               ...
               <tr >
                 ...
                 *
                  &nbsp;&nbsp;结算日期 
                  <input name="js"  id= "js" type="text" class="input3" size="20"  onFocus="setday(this)"readonly> <div style="position: absolute;" id="layer10"></div></td>
               </tr>
               <tr >
                 <td align="right" valign="middle" nowrap="nowrap">结帐方式</td>
                 <td align="left" valign="middle">
					<input  id="fanshi" size="35" 
                  name="fanshi"  style="border:1px solid #9d9d6c; FONT-SIZE: 12px; WIDTH: 114; HEIGHT: 16; BACKGROUND-COLOR: #ffffff" onBlur="miss(11)" />
                   *  <div style="position: absolute;" id="layer11"></div></td>
               </tr>
               <tr >
                 <td valign="middle" align="right">公司名称</td>
                 <td align="left" valign="middle">
					<input  id="company2" size="35" 
               ...
               <tr >
                 ...
                 <td align="left" valign="middle"><textarea class="message_textarea" name="content" rows="3" cols="33" style="BORDER-RIGHT: #9d9d6c 1px solid; BORDER-TOP: #9d9d6c 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #9d9d6c 1px solid; WIDTH: 271px; BORDER-BOTTOM: #9d9d6c 1px solid; HEIGHT: 95px; BACKGROUND-COLOR: #ffffff"></textarea>   <div style="position: absolute;" id="layer13"></div></td>
               </tr>
               <tr align="left" >
                 <td width="62%" 
                  colspan="2"><table width="558" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     <td colspan="3" align="left" valign="top"><img src="img/75.jpg" width="561" height="7"></td>
                   </tr>
                   <tr>
                     <td width="58" align="center" valign="top" bgcolor="#680001"><img src="img/77.jpg" width="35" height="33"></td>
                     <td width="479" align="left" valign="top" bgcolor="#680001" style="line-height:22px"><font color="#FFCC00"><strong>温馨提示:</strong><br>
                       ...
                       ·网上的酒店介绍、房态、价格等信息只作为参考，预订以最终电话、传真或短信确认</br>
                       &nbsp;                 准</font></td>
                     <td width="24" align="left" valign="top" bgcolor="#680001">　</td>
                   </tr>
                   <tr>
                     <td colspan="3" align="left" valign="top"><img src="img/76.jpg" width="561" height="7"></td>
                   </tr>
                 </table></td>
               </tr>
               <tr align="middle" >
                 <td height="43" colspan="2" align="center"><input type="hidden" name="tHtml" />
                     <input class="go-wenbenkuang" type="submit" value="确认订房" name="btnSend"  />
                   　　
                   <input class="go-wenbenkuang" type="reset" value="清除" name="btnClear" />                 </td>
               </tr>
             </tbody>
           </table>
          ...
          <tr>
            <td align="left" valign="top"><img src="img/73.jpg" width="626" height="41"></td>
          </tr>
        </table>
        <table width="632" border="0" cellspacing="0" cellpadding="0">
          <tr>
...
<div style="position:absolute;"id="layer100"></div></div>
<script language="javascript">
