  ...
  <table width="1003" height="580" border="0" cellpadding="0" cellspacing="0" background="img/47.jpg" bgcolor="#FFF4C7" >
    <tr>
      ...
      <td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="632" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="405" height="25" align="left" valign="middle">&nbsp;<font style="font-weight:bold; font-size:15px; color:6E4B25;">客房展示</font></td>
            <td width="227" align="right" valign="middle"><font style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:6E4B25;">LK International Hotel</font></td>
          </tr>
          <tr>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;房间内首家配备的内置机顶盒网络数字电视让您在CNN、BBC、NHK、国际电影频道、凤凰卫视等卫星电视频道和数字电影频道中感受全球瞬间变化，领略大千世界。 </p>
              ...
              <table width="537" height="97" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="261" align="center" valign="middle" style="line-height:20px"><a href="kfjg.jsp" ><img src="img/86.jpg" width="262" height="51" border="0" /></a></td>
                  <td width="292" align="center" valign="middle" style="line-height:20px"><a href="prices.jsp"><img src="img/48.jpg" alt="查看客房特设及价格" width="270" height="51" border="0" align="right" /></a></td>
                </tr>
              </table>              
          </tr>
        </table>
