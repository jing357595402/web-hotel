...
<body leftmargin="0" topmargin="0">
	<div align="center">
		...
		<table width="1003" border="0" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath }/portal/imgs/22047.jpg" bgcolor="#FFF4C7">
			<tr>
				<td width="234" height="580" align="left" valign="top" background="${pageContext.request.contextPath }/portal/imgs/02.jpg"><img src="${pageContext.request.contextPath }/portal/imgs/09.jpg" width="234" height="651" /></td>
				<td width="682" align="center" valign="top"><table width="632" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td><img src="${pageContext.request.contextPath }/portal/imgs/10.jpg" width="682" height="179" /></td>
						</tr>
					</table>
					...
					<table width="632" height="97" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td align="center" valign="middle" style="line-height: 20px"><a href="#"> <img src="${pageContext.request.contextPath }/portal/imgs/22065.jpg" alt="水疗馆" width="167"
									height="51" border="0" /></a></td>
							<td align="center" valign="middle" style="line-height: 20px"><a href="#"><img src="${pageContext.request.contextPath }/portal/imgs/22066.jpg" alt="健身中心" width="167"
									height="51" border="0" /></a></td>
							<td align="center" valign="middle" style="line-height: 20px"><a href="#"><img src="${pageContext.request.contextPath }/portal/imgs/22067.jpg" alt="中原首家泰国风情KTV" width="167"
									height="51" border="0" /></a></td>
						</tr>
					</table>
